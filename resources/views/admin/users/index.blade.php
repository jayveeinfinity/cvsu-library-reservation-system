    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                <br><br><br><br>
                <h1 class="m-0 text-white" style="text-shadow: 4px 4px 6px #838383;"><i class="fas fa-users"></i> Users</h1>
            </div>
            <div class="col-sm-6">
                    ...
                    <div class="card-body">
                        <div class="dataTables_wrapper dt-bootstrap4">
                            ...
                            @if(!$users->isEmpty())
                                <div class="row">
                                    <div class="col-sm-12 col-md-5">
                                        <div class="dataTables_info">Showing 1 to 1 of {{ $users->count() }} {{ Str::plural('entry', $users->count()) }}</div>
                                    </div>
                                    <div class="col-sm-12 col-md-7">
